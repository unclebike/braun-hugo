...
const ADMIN_JS_VERSION = 'b3fe945';
  ...
  if (btn._disarmTimer) clearTimeout(btn._disarmTimer);
        ...
        {html`<style>
          *, *::before, *::after { box-sizing: border-box; }
          ...
          .grid-masonry { display: grid !important; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)) !important; gap: 0.5rem !important; }
