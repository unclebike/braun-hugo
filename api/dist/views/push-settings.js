...
`;
export const PushSettingsPage = () => (_jsxs(Layout, { title: "Push Notifications", children: [_jsx("div", { class: "page-header", children: _jsx("h2", { children: "Push Notifications" }) }), _jsx("div", { class: "p-4 md:p-8", children: _jsx("div", { class: "grid gap-4 md:gap-6", style: "max-width:800px;", children: _jsxs("div", { class: "uk-card uk-card-body", children: [_jsx("h3", { class: "text-base font-semibold mb-2", children: "Staff Device Alerts" }), _jsx("p", { class: "text-sm text-muted-foreground mb-3", children: "Enable browser push on this device so staff get alerted for new jobs and new messages." }), _jsx("div", { id: "push-status", class: "text-sm mb-4 px-3 py-2 rounded", style: "background:var(--surface-elevated,#eff1f5);color:var(--text-primary,#333);border:1px solid var(--border,#ccd0da);", children: "Checking push support..." }), _jsxs("div", { class: "grid gap-2 mb-4", children: [_jsxs("label", { class: "flex items-center gap-2 text-sm", for: "push-notify-jobs", children: [_jsx("input", { id: "push-notify-jobs", type: "checkbox", class: "uk-checkbox", checked: true }), _jsx("span", { children: "Notify on new jobs" })] }), _jsxs("label", { class: "flex items-center gap-2 text-sm", for: "push-notify-messages", children: [_jsx("input", { id: "push-notify-messages", type: "checkbox", class: "uk-checkbox", checked: true }), _jsx("span", { children: "Notify on new messages" })] })] }), _jsxs("div", { class: "flex items-center gap-2", style: "flex-wrap:wrap;", children: [_jsx("button", { id: "push-enable-btn", type: "button", class: "uk-btn uk-btn-primary uk-btn-sm", children: "Enable on this device" }), _jsx("button", { id: "push-disable-btn", type: "button", class: "uk-btn uk-btn-default uk-btn-sm", children: "Disable on this device" }), _jsx("button", { id: "push-test-btn", type: "button", class: "uk-btn uk-btn-default uk-btn-sm", children: "Send test notification" })] }), _jsx("p", { class: "text-xs text-muted-foreground mt-3", children: "Tip: install the admin as a PWA for the most reliable delivery, especially on iOS." })] }) }) }), html `<script>
(function() {
