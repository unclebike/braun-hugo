...
<div class="kg-card kg-toggle-card" data-kg-toggle-state="close">
            <div class="kg-toggle-heading">
                <h4 class="kg-toggle-heading-text"><span style="white-space: pre-wrap;">Wheels-On Tweak &amp; Tune</span></h4>
            ...
            <div class="kg-toggle-content"><p><span style="white-space: pre-wrap;">Every bike has its quirks—this service covers the essentials to keep yours rolling safe and smooth. I’ll wipe it down, dial in the brakes and gears, check balance of spoke tension and top up the tire pressure so you’re ready to ride. Simple, solid, and right at your doorstep. </span></p></div>
        </div><div class="kg-card kg-toggle-card" data-kg-toggle-state="close">
            <div class="kg-toggle-heading">
                <h4 class="kg-toggle-heading-text"><span style="white-space: pre-wrap;">Pre-Scheduled Semi Annual Service </span></h4>
                <button class="kg-toggle-card-icon" aria-label="Expand toggle to read content">
                    <svg id="Regular" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path class="cls-1" d="M23.25,7.311,12.53,18.03a.749.749,0,0,1-1.06,0L.75,7.311"></path>
                    </svg>
